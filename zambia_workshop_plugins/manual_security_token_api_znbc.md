# Security for ZNBC API

### 1. Add this to your **.htaccess** file by adding the following to enable **HTTP Authorization Header**
...
### 2. Changes in your wp-config.php file. 
2.1 Add a new constant called **JWT_AUTH_CORS_ENABLE** to enable the CORs Support. 

2.2 Add the **secret key** to your wp-config.php file and add a new constant called **JWT_AUTH_SECRET_KEY**.
...
### 3. Activate the JWT Authentication for WP-API plugin

## Namespace and Endpoints

When the plugin is activated, a new namespace is added. Check


```apacheconf
# Check the http://127.0.0.1/wordpress/wp-json/jwt-auth/v1
/jwt-auth/v1
```
...
| Endpoint                              | HTTP Verb |
| ------------------------------------- | --------- |
| *http://127.0.0.1/wordpress/wp-json/jwt-auth/v1/token*          | POST      |
| *http://127.0.0.1/wordpress/wp-json/jwt-auth/v1/token/validate* | POST      |

http://localhost/wordpress/wp-json/jwt-auth/v1/token
http://localhost/wordpress/wp-json/jwt-auth/v1/token/validate

http://localhost/wordpress//index.php/wp-json/jwt-auth/v1/token
http://localhost/wordpress//index.php/wp-json/jwt-auth/v1/token/validate
